...
% Shon and Alex May 22, 2016
function obj = SaltStepAnalysisNew(obj)
% minus 1 to remove last DIW step...
numOfReagents = length(obj.reagentChangeIndex)-1;
...
%hack to fix not putting RI's into recipe file
RI = [1.3328, 1.3335, 1.3342, 1.3354, 1.3377, 1.3431];

includeRICheck = ones(1, numOfReagents);
for r = 1:numOfReagents
    if strcmp(ReagentNames{r}, 'DIW') || strcmp(ReagentNames{r}, '1M-NaCl')
...
if  appendIndex < numOfReagents
    ...
    includeReagentChangeIndex(end + 1) = 120;
end

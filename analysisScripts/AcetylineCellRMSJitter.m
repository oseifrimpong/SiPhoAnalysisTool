...
function obj = AcetylineCellRMSJitter(obj)
wb = waitbar(0, 'Acetylene Cell RMS jitter analysis -- assumes acetylene cell is ch4');
movegui(wb, 'center');
...
delete(wb)
msgbox('Acetylene Cell RMS jitter analysis!', 'Testbench Characterization');
end